...
?>
  ...
  <div class="btn-group">
    <a href="Nuevo_Usuario.php" class="btn btn-primary">Nuevo usuario</a></button>
    <a href="Actualizar_Usuario.php" class="btn btn-primary">Actualizar usuario</a></button>
    <a href="Eliminar_Registro_Usuario.php" class="btn btn-primary">Eliminar usuario</a></button>
