...
?>  
    ...
    <form name="Registro" action="Insertar_CC.php" method="post">
    <div class="row">
    <div class="col-sm-3">
      <br>Solped: <input type="text" class="form-control" name="solped" min="0" step="any" required autofocus>
    </div>
    <div class="col-sm-6">
      <br>Familia: <input type="text" class="form-control" name="familia">
    </div>
    <div class="col-sm-3">
      <br>Piezas: <input type="number" class="form-control" name="piezas" min="0" step="any" value="0.00" required>
    </div>
    </div>
    <div class="row">
    <div class="col-sm-3">
      <br>Importe: <input type="number" class="form-control" name="importe" min="0" step="any" value="0.00" required>
    </div>
    <div class="col-sm-3">
      <br>Junta de Aclaraciones: <input type="text" class="form-control" name="junta" placeholder="Fecha">
    </div>
    <div class="col-sm-3">
      <br>Fallo: <input type="text" class="form-control" name="fallo" placeholder="Fecha">
    </div>
    <div class="col-sm-3">
      <br>Contrato: <input type="text" class="form-control" name="contrato" placeholder="Fecha">
    </div>
    </div>
    <br><br><center><input type="submit" class="btn btn-primary" value="Guardar"> 
    <a href="Consulta_CC.php" class="btn btn-primary">Cancelar</a></center><br>
    </form>
