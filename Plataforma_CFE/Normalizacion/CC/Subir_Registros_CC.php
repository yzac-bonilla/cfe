...
<div class="container">
  ...
  <h2>Subir registros desde un documento CSV</h2><br>
...
?>  
    ...
    <form action="Upload_CSV_CC.php" enctype="multipart/form-data" method="post">
       <input id="archivo"  class="form-control" accept=".csv" name="archivo" type="file" /> 
       <input name="MAX_FILE_SIZE" type="hidden" value="20000" /><br>
       <center>
       <p><font color='Navy' size="2">Asegúrese de que el documneto csv contenga las mismas columnas y filas que la tabla de la página web, que los campos no contengan comas, que no se repita el mismo número para el campo Id, que cada campo contenga caracteres válidos según su tipo de dato.</font></p>
       <br><input name="enviar" type="submit" value="Subir CSV" class="btn btn-primary"/>
       <a href="Consulta_CC.php" class="btn btn-primary">Cancelar</a><br></center>
    </form>
