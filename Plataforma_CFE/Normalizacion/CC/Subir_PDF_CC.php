...
?>
  ...
  <form action="Upload_PDF_CC.php" method="post" enctype="multipart/form-data">
    <select class="form-control" name="id" autofocus>
      <option value="NO ESPECIFICADO" selected>Seleccionar registro</option>
      <?php
      $filtro=mysqli_query($conexion,"SELECT * FROM cc ORDER BY Familia");
    ...
    <br><center><input type="file" class="form-control" accept=".pdf" name="fileToUpload" id="fileToUpload">
    <br><input type="submit" value="Subir PDF" name="submit" class="btn btn-primary">
