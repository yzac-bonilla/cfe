...
<div class="container">
  ...
  <div class="btn-group">
    ...
    <a href="CC.php" class="btn btn-info">Atras</a></button>
  </div>
  <br><br>
  ...
  <div class="col-md-6" align="left">
    <form action="Consulta_CC_Filtros.php" name="opcion" method="post">
      ...
      <option value="Piezas">Piezas</option>
      <option value="Importe" selected>Importe</option>
      <option value="Junta">Junta de Aclaraciones</option>
      <option value="Fallo">Fallo</option>
      <option value="Contrato">Contrato</option>
    </select>
  ...
  <div class="col-md-6" align="right">
    <form method="POST" action="Consulta_CC_Busqueda.php" onSubmit="return validarForm(this)"><br>
  ...
  while($row=mysqli_fetch_array($result))
  {
    ...
    <?php
    /*if(!file_exists("Contenido/".$row["Familia"].".php"))
    {
        $file = "Contenido/Template.php";
        $newfile = "Contenido/".$row["Familia"].".php";
