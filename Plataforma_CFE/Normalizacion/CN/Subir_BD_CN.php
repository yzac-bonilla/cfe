...
<div class="container">
  ...
  <h2>Subir base de datos desde un documento CSV</h2><br>
...
?>  
    ...
    <form action="Upload_CSV_CN.php" enctype="multipart/form-data" method="post">
       ...
       <a href="Base_Datos_CN.php?id=<?=$año?>" class="btn btn-primary">Cancelar</a><br></center>
    </form>
