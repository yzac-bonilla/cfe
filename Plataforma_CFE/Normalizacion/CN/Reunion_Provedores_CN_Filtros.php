 <?php
  ...
  {
    $buscar_y="Provedor like '%".$buscar_2."%'";
    $color_y="#cc0000";
  }
?>
...
<div class="container">
  ...
  <?php     
  $consulta_mysql= mysqli_query ($conexion,"SELECT * FROM cn_reunion_provedor WHERE $buscar_x $aux $buscar_y");
  ?>
  <font size="2">
  <div id="imprimir">
     ...
     while($row = mysqli_fetch_assoc($consulta_mysql)) 
     {
      ?> 
        <tr>
          ...
          <td><font color="<?=$color_y?>"><b><?=$row["Provedor"]?></b></font></td>
          <td><font color="<?=$color_x?>"><?=$row["Tema"]?></font></td>
