...
<div class="container">
  ...
  <h2>Buscar en todas las bases de datos</h2>

  <form action="Busqueda_BD_CN.php" method="post">
    <br>Empresa:
    ...
    <br>Familia:
    <select class="form-control" name="familia" autofocus>
      <option value="NO ESPECIFICADO" selected>Seleccionar</option>
      <?php
      $filtro=mysqli_query($conexion,"SELECT DISTINCT Familia FROM cn_familia");
      while($fila=mysqli_fetch_array($filtro))
      {
          ?>
    ...
    <br><br><center><input type="submit" class="btn btn-primary" value="Buscar" required> 
    <a href="Conformidad_Normativa.php" class="btn btn-primary">Cancelar</a></center><br>
    </form>
