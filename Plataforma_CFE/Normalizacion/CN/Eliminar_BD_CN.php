  ...
  while ($row=mysqli_fetch_array($result)) 
	{
        ...
        <?php
          printf("<td bgcolor='#ffbfbf'><a href='Eliminar_BD.php?id=%s' onclick=\"return confirmar('¿Está seguro que desea eliminar el registro?')\">Borrar</button></td>",$row["Base_Datos"]);
        ?>
	      <td><strong><?=$row["Base_Datos"]?></strong></td>
	    </tr>
	    <?php
	}
