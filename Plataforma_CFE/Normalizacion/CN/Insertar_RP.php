...
<?php
  ...
  $date = str_replace("/","-",$fecha);
	...
	$sql="INSERT INTO cn_reunion_provedor (Id,Fecha,Provedor,Tema,Documentacion,Nota_Informativa) VALUES ('$no','$date','$provedor','$tema','$documentacion','$nota_informativa');";
	if ($conexion->query($sql) === TRUE) 
	{
      include ("../../Usuarios/Historial.php");
      $actividad = "Creación de un nuevo registro en reunion con los provedores de Conformidad Normativa.";
