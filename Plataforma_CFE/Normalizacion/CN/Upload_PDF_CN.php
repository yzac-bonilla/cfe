...
<div class="panel-heading"> 
    <ul class="pager">
      <li class="previous"><a href="Subir_PDF_CN.php?id=<?=$año?>">Regresar</a></li>
    </ul>
</div>
...
if($FileType == "pdf")
{
    $target_dir = "Contenido/bd_".$año."/pdf/";
}
else
{
...
$target_file =$target_dir.$oficio.".".$FileType;
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) 
    {
        include("../../api/php/Conexion_Plataforma.php");
        $conexion = Conectar();
        include ("../../Usuarios/Historial.php");
        $actividad = "Subir un documento pdf a la base de datos ".$año." en Conformidad Normativa.";
