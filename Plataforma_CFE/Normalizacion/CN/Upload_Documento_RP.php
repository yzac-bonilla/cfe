...
<div class="panel-heading"> 
    <ul class="pager">
      <li class="previous"><a href="Subir_Documento_RP.php">Regresar</a></li>
    </ul>
</div>
...
if($FileType == "pdf")
{
    $target_dir = "Contenido/Reunion_Provedores/pdf/";
}
elseif($FileType == "docx" || $FileType == "doc")
{
    $target_dir = "Contenido/Reunion_Provedores/docx/";
}
elseif($FileType == "pptx" || $FileType == "ppt")
{
    $target_dir = "Contenido/Reunion_Provedores/pptx/";
}
elseif($FileType == "xlsx" || $FileType == "xls" || $FileType == "xlsm")
{
    $target_dir = "Contenido/Reunion_Provedores/xlsx/";
}
elseif($FileType == "jpg" || $FileType == "jpeg" || $FileType == "png" || $FileType == "gif" || $FileType == "bmp" || $FileType == "tif" || $FileType == "tiff")
{
    $target_dir = "Contenido/Reunion_Provedores/img/";
}
else
{
...
$target_file =$target_dir .rand(1000000,9999999)."_".basename($_FILES["fileToUpload"]["name"]);
$enlace = "<a href=\'".$target_file."\' target=\'_blank\'>".basename($_FILES["fileToUpload"]["name"])."</a>";
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) 
    {
        include("../../api/php/Conexion_Plataforma.php");
        $conexion = Conectar();
        $sql=mysqli_query($conexion,"UPDATE cn_reunion_provedor SET $campo='$enlace' WHERE Id='$id'");
        include ("../../Usuarios/Historial.php");
        $actividad = "Subir un documento a reunión con los provedores en Conformidad Normativa.";
