...
<div class="container">
  ...
  <div class="jumbotron">
    <h1>Construcción</h1>
    <p>Programa General de Licitaciones</p>      
  </div> 
...
?>
    ...
    <form action="Upload_CSV_PGL.php" enctype="multipart/form-data" method="post">
       ...
       <a href="Consulta_PGL.php" class="btn btn-primary">Cancelar</a><br></center>
    </form>
