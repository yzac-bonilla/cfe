...
<?php  
 ...
 {   
  $buscar = $_POST["palabra"];
    $consulta_mysql= mysqli_query ($conexion,"SELECT * FROM pgl WHERE Proyecto like '%$buscar%'");
    ?>
...
<section>
  ...
  while($row=mysqli_fetch_array($consulta_mysql))
  {
    ...
    <tr>
      <th><b><?=$row["No"]?></b></th>
      <td><font color="#cc0000"><b><?=$row["Proyecto"]?></b></font></td>
  ...
  <tr>
      ...
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(SE) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(LT) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(Alimentadores_AT) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(Alimentadores_MT) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(MVA) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(MVAr) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(KmC) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(Numero_Aliment) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(Medidores) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(Transformadores_Distribucion) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(Postes) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong><?=$row['sum']?></strong></td>
      <td colspan="14"></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(Act_Prev_Inv) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong>$<?php echo number_format($row['sum'], 2, '.', ','); ?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(Monto_Max_Publicado) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result); 
      ?>
      <td><strong>$<?php echo number_format($row['sum'], 2, '.', ','); ?></strong></td>
      <?php  
        $result = mysqli_query($conexion,"SELECT SUM(Monto_Adjudicado) AS sum FROM pgl WHERE Proyecto like '%$buscar%'"); 
        $row = mysqli_fetch_assoc($result);
