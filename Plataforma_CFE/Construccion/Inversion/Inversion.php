  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Construccción<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="../PGL/OPF.php">Obras Publicas Financiadas</a></li>
...
<div class="container">
  ...
  <div class="list-group">
    <a href="#" class="list-group-item list-group-item-success">BCA</a><br>
    <a href="#" class="list-group-item list-group-item-success">NOE</a><br>
    <a href="#" class="list-group-item list-group-item-success">NTE</a><br>
    <a href="#" class="list-group-item list-group-item-success">GNT</a><br>
    <a href="#" class="list-group-item list-group-item-success">GCO</a><br>
    <a href="#" class="list-group-item list-group-item-success">BAJ</a><br>
    <a href="#" class="list-group-item list-group-item-success">COC</a><br>
    <a href="#" class="list-group-item list-group-item-success">COR</a><br>
    <a href="#" class="list-group-item list-group-item-success">CSR</a><br>
    <a href="#" class="list-group-item list-group-item-success">STE</a><br>
    <a href="#" class="list-group-item list-group-item-success">OE</a><br>
    <a href="#" class="list-group-item list-group-item-success">PEN</a><br>
    <a href="#" class="list-group-item list-group-item-success">VMN</a><br>
    <a href="#" class="list-group-item list-group-item-success">VMC</a><br>
    <a href="#" class="list-group-item list-group-item-success">VMS</a><br>
  </div>
